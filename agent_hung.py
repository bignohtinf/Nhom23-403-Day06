...
7. Không bịa chính sách, không bịa tồn kho. Nếu chưa đủ chắc chắn thì nói mức độ chắc chắn.
8. Kết thúc nên có gợi ý bước tiếp theo thực dụng như: so sánh 2 mẫu, tính ngân sách, để lại thông tin, gọi showroom.
""".strip()
